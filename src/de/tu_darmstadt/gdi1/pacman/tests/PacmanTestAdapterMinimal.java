...
public class PacmanTestAdapterMinimal
{
	...
	/**
	 * Gibt true aus, wenn aus dem String content ein gültiger Level geladen werden kann, ansonsten false.
	 * Auftretende Exceptions werden abgefangen und haben immer die Rückgabe false zur Folge.
	 * 
	 * @param content
	...
	/**
	 * Parst einen Level aus dem String content und leitet dabei die entsprechenden Parserexceptions weiter.
	 * 
	 * @param content Textdarstellung des Levels
	 ...
	 */
	public void levelIsValidWithException(String content) throws InvalidLevelCharacterException, InvalidLevelFormatException, NoPacmanSpawnPointException, ReachabilityException, NoGhostSpawnPointException, NoItemsException
	{
		LevelParser.fromString(content).validate();
	}
	...
	/**
	 * Startet ein neues Spiel und platziert alle Items und Figuren.
	 * Das gestartete Spiel soll für die folgenden Aufrufe der Spielsteuerung verwendet werden.
	 * 
	 * @param level Textdarstellung des Levels
	 */
	...
	/**
	 * Gibt den char zurück, der das Feld im Level des laufenden Spiels an der Position x,y repräsentiert.
	 * 
	 * @param x
	 * @param y
	...
	/**
	 * Gibt die Textdarstellung des aktuell laufenden Levels aus (.toString-Methode).
	 * 
	...
	/**
	 * Versucht die Spielfigur ein Feld nach Oben zu bewegen und gibt aus, ob die Bewegung erfolgreich war.
	 * Wenn die Bewegung nicht möglich ist, oder in diesem Tick bereits eine Bewegung durchgeführt wurde, soll der Befehl ignoriert werden.
	 * 
	...
	/**
	 * Versucht die Spielfigur ein Feld nach Links zu bewegen und gibt aus, ob die Bewegung erfolgreich war.
	 * Wenn die Bewegung nicht möglich ist, oder in diesem Tick bereits eine Bewegung durchgeführt wurde, soll der Befehl ignoriert werden.
	 * 
	 * @return True, wenn die Bewegung möglich war, sonst false.
	 */
	...
	/**
	 * Versucht die Spielfigur ein Feld nach Unten zu bewegen und gibt aus, ob die Bewegung erfolgreich war.
	 * Wenn die Bewegung nicht möglich ist, oder in diesem Tick bereits eine Bewegung durchgeführt wurde, soll der Befehl ignoriert werden.
	 * 
	 * @return True, wenn die Bewegung möglich war, sonst false.
	 */
	...
	/**
	 * Versucht die Spielfigur ein Feld nach Rechts zu bewegen und gibt aus, ob die Bewegung erfolgreich war.
	 * Wenn die Bewegung nicht möglich ist, oder in diesem Tick bereits eine Bewegung durchgeführt wurde, soll der Befehl ignoriert werden.
	 * 
	 * @return True, wenn die Bewegung möglich war, sonst false.
	 */
	...
	/**
	 * Platziert die Spielfigur auf einer beliebigen Position, ohne Prüfungen durchzuführen.
	 * 
	 * @param x
	 * @param y
	 */
	...
	/**
	 * Bewegt den Geist zu einer beliebigen Position, ohne Prüfungen durchzuführen.
	 * 
	 * @param x
	 * @param y
	 */
	...
	/**
	 * Führt einen Schritt in der Spiellogik, wie das Bewegen von Figuren und prüfen auf Kollisionen, aus.
	 */
	public void update()
	{
		game.updateStep();
	...
	/**
	 * Gibt aus, wie oft die die Spielfigur unter Einfluss eines PowerUps einen Geist gefressen hat.
	 * 
